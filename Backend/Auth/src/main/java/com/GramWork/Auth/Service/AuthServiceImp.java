...
import com.GramWork.Auth.Repository.AdminRepo;
...
public class AuthServiceImp implements AuthService{
    ...
    @Override
    public String AdminLogin(AdminRequest request) {
        ...
        return jwtUtils.generateToken(admin.getUsername(), String.valueOf(admin.getRole()));
    }
}
